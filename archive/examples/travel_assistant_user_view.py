"""Travel assistant example showing only the final output to the user."""
import os
...
def process_user_query(query: str) -> str:
    ...
    while response.tool_calls:
        ...
        for tool_call in response.tool_calls:
            ...
            elif tool_call['name'] == "GetDirections":
...
def main():
    """Run the travel assistant example with only the final output shown to the user."""
    # User query
    user_query = "I'm visiting Portland and would like to find some good Italian restaurants. After dinner at Italian Delight (123 Main St), I'll need directions from downtown Portland (Pioneer Courthouse Square) to the Japanese Garden."
