"""Interactive travel assistant example."""
import os
...
def main():
    """Run the interactive travel assistant example."""
    ...
    print("Ask me about restaurants or directions in any city.")
    print("Example: 'I'm visiting Portland and would like to find some good Italian restaurants.'")
