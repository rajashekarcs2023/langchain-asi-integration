"""
This file contains a fixed implementation of the _create_chat_result method
for the ChatASI class in langchain_asi/chat_models.py.

This implementation properly handles ASI's unique tool calling behavior by detecting
when finish_reason is "tool_calls" and extracting tool call information from the content field.
"""
